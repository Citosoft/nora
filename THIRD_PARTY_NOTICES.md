...
Generated: 2026-04-29T12:14:19.570Z

| Package | Version | License |
| --- | --- | --- |
| @ai-sdk/anthropic | 3.0.71 | Apache-2.0 |
| @ai-sdk/google | 3.0.64 | Apache-2.0 |
| @ai-sdk/openai | 3.0.53 | Apache-2.0 |
| @ai-sdk/react | 3.0.170 | Apache-2.0 |
...
| ai | 6.0.168 | Apache-2.0 |
| class-variance-authority | 0.7.1 | Apache-2.0 |
| clsx | 2.1.1 | MIT |
| geist | 1.7.0 | SIL OPEN FONT LICENSE |
| lucide-react | 0.511.0 | ISC |
| monaco-editor | 0.55.1 | MIT |
| node-pty | 1.1.0 | MIT |
| posthog-js | 1.365.0 | SEE LICENSE IN LICENSE |
| react | 19.2.4 | MIT |
