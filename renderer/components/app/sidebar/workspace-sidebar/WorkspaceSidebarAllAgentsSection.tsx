            ...
            <div className="space-y-3">
              {allAgentsGroupSections.map((section) => (
                <div key={section.groupKey} className="space-y-1">
                  {section.groupLabel ? (
                    <div className="px-2 pt-0.5 text-[11px] font-semibold uppercase tracking-wide text-muted-foreground">
                      {section.groupLabel}
                    </div>
                  ) : null}
                    ...
                    {section.entries.map((entry) => {
                      ...
                      return (
                        <button
                          ...
                          className={cn(
                            "flex w-full min-w-0 items-center gap-2 rounded-[4px] border px-2 py-1.5 text-left transition",
                            isFocusedAgent
                        ...
                        >
                          ...
                          {isBusy ? <BusyIndicator className="size-3.5 shrink-0" /> : null}
